...
fn test_uninitialized() {
    ...
    pegkeeper_client.fl_receive(&Address::generate(&env), &0, &Address::generate(&env), &Address::generate(&env), &Address::generate(&env), &0, &0, &Address::generate(&env), &0, &Address::generate(&env));
}